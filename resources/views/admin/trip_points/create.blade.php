...
@section('page', 'Add Trip Point')

@section('content')
<div class="card shadow-sm">
    <div class="card-header">
        <h5 class="mb-0">Add New Trip Point</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.trip_points.store') }}" method="POST">
            @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <textarea name="map" class="form-control" rows="3" placeholder="Paste Google Maps iframe here"></textarea>
                </div>
            </div>
